...
Tuesday Apr. 2     | **[Bloodroot revisited](https://gnetum.eeb.uconn.edu/courses/phylogenetics/sanguinaria.pdf)**; **[Independent Contrasts](https://gnetum.eeb.uconn.edu/courses/phylogenetics/19a-indep-contrasts.pdf)**; **[PGLS regression](https://gnetum.eeb.uconn.edu/courses/phylogenetics/19b-pgls-regression.pdf)** | **Homework 11** [Simulating a character using the Brownian motion model](/hwbmsim/)
