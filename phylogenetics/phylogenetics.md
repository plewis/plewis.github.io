...
Tuesday Feb. 27    | **[MCMC (cont.)](https://gnetum.eeb.uconn.edu/courses/phylogenetics/11-mcmc2.pdf); [Model selection](https://gnetum.eeb.uconn.edu/courses/phylogenetics/11-model-selection.pdf)** | **Homework 7** [MCMC](/hwmcmc/) due 2024-03-05
Thursday Feb. 29   | **Hierarchical and empirical Bayesian models**                | **Lab 7** [Using R to explore probability distributions](/rprobdist/) (start with Lognormal, questions 20-29)
